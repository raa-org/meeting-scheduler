...
if (!function_exists('apexianlab_email_cancelled_details_info_block')) {
    function apexianlab_email_cancelled_details_info_block(
        string $person_icon,
        string $primary,
        string $secondary,
        string $font_stack
                ...
                <tr>
                    <td align="left" style="padding:16px 0 0 0;">
                        <p style="
                            ...
                            The details of the cancelled meeting are below.
                        </p>
                    </td>
                </tr>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
                                                    <tr>
                                                        <td width="50%" valign="top" style="padding:0 12px 0 0;">
                                                            <?php
                                                            apexianlab_email_cancelled_details_info_block(

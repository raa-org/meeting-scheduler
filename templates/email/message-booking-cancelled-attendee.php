...
if (!function_exists('apexianlab_email_attendee_cancelled_details_info_block')) {
    function apexianlab_email_attendee_cancelled_details_info_block(
        string $person_icon,
        string $primary,
        string $secondary,
        string $font_stack
                ...
                <tr>
                    <td align="left" style="padding:16px 0 0 0;">
                        <p style="
                                ...
                                color:#0A0A0A;
                                ">
                            <?php if ($attendee_display !== '') : ?>
                                Hi <strong style="font-weight:700;"><?php echo esc_html($attendee_display); ?></strong>,
                                <br>
                            <?php endif; ?>
                            Your meeting
                            <?php if ($organiser_name !== '') : ?>
                                with <strong style="font-weight:700;"><?php echo esc_html($organiser_name); ?></strong>
                            <?php endif; ?>
                            has been cancelled. The details are below.
                        </p>
                    </td>
                </tr>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
                                                    <tr>
                                                        <td width="50%" valign="top" style="padding:0 12px 0 0;">
                                                            <?php
                                                            apexianlab_email_attendee_cancelled_details_info_block(
                                                                $icons . 'person-icon.svg',
                                                                $organiser_name !== '' ? $organiser_name : $schedule_name,
                                                                '',
                                                                $font_stack
                                                            );
                                                            ?>

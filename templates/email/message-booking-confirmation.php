...
$is_reschedule   = (bool) ($args['is_reschedule'] ?? false);
$original_date   = $args['original_date'] ?? null; // DateTime|null
                ...
                <tr>
                    <td align="left" style="padding:16px 0 0 0;">
                        <p style="
                                ...
                                color:#0A0A0A;
                                ">
                            Hi <strong style="font-weight:700;"><?php echo esc_html($target_name); ?></strong>,
                            <?php if ($is_reschedule) : ?>
                                Your meeting has been rescheduled!
                                To confirm the new time, please click the link below.
                            <?php else : ?>
                                ...
                                <td valign="middle" style="padding:0 12px 8px 0;">
                                    <a href="<?php echo esc_url($link); ?>"
                                       ...
                                       target="_blank" rel="noopener">
                                        <?php echo $is_reschedule ? 'Confirm reschedule' : 'Confirm booking'; ?>
                                    </a>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <tr>
                                <td style="padding:24px;">
                                    ...
                                    <?php if ($is_reschedule && $original_date !== null) : ?>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="left" style="padding:16px 0 0 0;">
                                                <p style="margin:0;padding:12px;background:#FFF3E0;border-left:4px solid #FF9800;border-radius:4px;font-family:<?php echo esc_attr($font_stack); ?>;font-size:13px;line-height:150%;font-weight:500;color:#0A0A0A;">
                                                    ...
                                                    <?php echo esc_html($original_date->format('l, F j \a\t g:i a')); ?>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>

...
**[Live demo](https://apexianlab-calendar.rightandabove.com/)** · **[White paper](WHITEPAPER.md)** · **[Security policy](SECURITY.md)**
...
![Public booking calendar](screenshots/02-booking.png)

### Organiser sign-in

Schedule owners connect with Google — the same OAuth grant powers Calendar access.

![Google sign-in](screenshots/01-sign-in.png)
...
- [White paper](WHITEPAPER.md) — problem analysis, industry context, and architecture
